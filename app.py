...
st.markdown("<br><hr><center>Made with 🤍 by <a href='mailto:joyanindya99@gmail.com?subject=Low Light Image Enhancement WebApp!&body=Please specify the issue you are facing with the app.'><strong>Anindya Sen</strong></a></center><hr>", unsafe_allow_html=True)
